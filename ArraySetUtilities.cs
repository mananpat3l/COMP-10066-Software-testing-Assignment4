...
namespace COMP10066Lab5
{
    ...
    {
        /// <summary>
        /// Will create a List of integers within an inclusive range.  Option to generate unique elements is included
        /// </summary>
        ...
        /// <returns>List of Integers with the inclusive range given.  List will be unique (contain no duplicates) if uniqueElements is true</returns>
